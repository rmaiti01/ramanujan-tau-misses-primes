...
name: Axler Proof Pedagogy Guide
description: Helps understand and explain Lean 4 proofs written using the Axler theorem prover, translating formal proof structure into pedagogically clear explanations for mathematical experts.
